...
!function(e,n){
    ...
    function t(e){
        var i=new RegExp("(^| )"+e+"=([^;]*)(;|$)"),t=n.cookie.match(i);
        return t?t[2]||"":""
    }
    function o(){
    ...
    function r(){
        var n=(new Date).getTime();if(8e3>n-c){
            var o=t("cna"),a=t("nickname");
            if(o||a){
                i("//g.alicdn.com/alilog/oneplus/blk.html#coid="+encodeURIComponent(o)+"&noid="+encodeURIComponent(a))
            }
            else e.setTimeout(function(){r()},300)
        }
    }

    try{
        var d="_oid_ifr_",c=(new Date).getTime();o()||a()||r()
    }
    catch(f){}
}(window,document);